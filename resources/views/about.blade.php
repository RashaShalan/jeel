...
@section('content')
      ...
      <section class="header-section">
        <div class="banner">
          <img src="{{ asset('front-assets/images/cover-about.png')}}" alt="">
        </div>
      ...
      <!--==============================Start About Section ==============================-->
      <section class="about-overview-section mb-section py-section">
          ...
          <div class="row align-items-center flex-column-reverse flex-md-row">
            ...
            <div class="col-md-6">
              ...
              <div class="charts">
                <div class="chart">
                  <div>
                    <img src="{{ asset('front-assets/images/chart1.svg')}}">
                  </div>
                  <div class="analyst">
                ...
                <div class="chart">
                  <div>
                    <img src="{{ asset('front-assets/images/chart2.svg')}}">
                  </div>
                  <div class="analyst">
                    <p><span><svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <section class="feature-section mb-section py-section">
        <div class="container-xl">
          <div class="row flex-column flex-md-row">
            ...
            <div class="col">
              <div class="title__section">
                ...
                <div class="head text-primary">لذا كان تطبيق جــيل</div>
                <div class="main-text">
                  <p>
                    أول تطبيق عربي يخلق عالما متكاملا من المحتوى الترفيهي الآمن
                    للطفل، كل ما نـقـدمه من مسلسلات وأنـاشيد وألعـاب ممتعـة هو
                    محتـوانــــــا الأصلي يصممــه مبدعونا وفقا لمنظومة معايير
                    أخلاقية طورهــــا فــــــــــريق من الخـبـــــــراء
                    التربويين، وبلغـة عـــــربيــة سليمـــــة لــتـعـــزيز
                    مهــــــارات اللـــغة؛ تتوفـر كـذلك واجهــة مستخـــــدم
                    بـــــــاللغة الإنجليزية تمكينــاً لمستخـدمينــا غيــر
                    النـــاطقين بـالعــــربية. كمـا وضعنا قسم للآباء يوفر أدوات
                    متابعة مفيدة لأنهم شركاؤنا الأساسيين في رحلة تعلم أبناءهم.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="row text-center mb-section">
            <div class="title__section">
              ...
              <div class="head text-blacklight">
                مـا يقــدمه جيـــل للأطفال واليافعين:
              </div>

            </div>
            <div class="main-text">
              <p>
                للطفل حسابه المستقل في جيل؛ سيجد فيه كافة أنواع المحتـــــــوى
                التي يبحث عنهـــا وما هو أكـــثر في 6 أقســـــــام:
              </p>
            </div>
          </div>
          <div class="row">
            <div class="features-list">
              <div class="item">
                <div class="main-card">
                  ...
                  <div class="main-title">مسلسلات جيل</div>
                </div>
              </div>
              <div class="item">
                <div class="main-card">
                  ...
                  <div class="main-title">اقرأ مع جيل</div>
                </div>
              </div>
              <div class="item">
                <div class="main-card">
                  ...
                  <div class="main-title">تعلم ومهارات</div>
                </div>
              </div>
              ...
              <div class="item">
                <div class="main-card">
                  ...
                  <div class="main-title">ألعاب جيل</div>
                </div>
              </div>
              <div class="item">
                <div class="main-card">
                  ...
                  <div class="main-title">راديو جيل</div>
                </div>
              </div>
              <div class="item">
                <div class="main-card">
                  ...
                  <div class="main-title">أناشيد جيل</div>
                </div>
      ...
      <section class="feature-section-parents mb-section py-section">
        <div class="container-xl">
          <div class="row">
            <div class="col-12">
              <div class="title__section text-center">
                ...
                <div class="head text-primary mb-2">ما يوفره جيل للوالدين</div>
              </div>
            ...
            <div class="col-12">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="details">
                    <div class="h1">تقـارير مفصلة للاستخــدام</div>
                    <ul>
                      <li>
                        يحتوي التقـرير على عدد ساعات استخـــدام الطفل و مشاهداته
                      </li>
                      <li>
                        يســـــاعد على معـرفة المحتوى الذي يميل إليــــــه الطفل وترشيد عدد ساعات استخدامه وتوجيهه
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="details">
                    <div class="h1">4 حسابــات × حســاب واحــد</div>
                    <ul>
                      <li>الاشتراك الواحد يعطيك حرية إنشاء حـتى ثلاثة حسابات </li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div class="row flex-column-reverse flex-md-row">
                <div class="col-md-6">
                  <div class="details">
                    <div class="h1">موسيقي أو بدون موسيقى: </div>
                    <ul>
                      <li>يأتي التطبيق بنسختين يمكنك اختيار أيهما والتبديل بينهما بسهولة من خلال إعدادات.</li>
                    </ul>
                  </div>
                </div>
                <div class="col-md-6">
      ...
      <!--==============================End parents Section ==============================-->
      <!--==============================Start Stats Section ==============================-->
      <section class="stats-section mb-section py-section">
        <div class="container-xl">
          <div class="row">
            <div class="title__section text-center">
              <div class="subhead text-blue mb-2"><span> ما حققناه </span></div>
              <div class="head text-primary">
                جـــيل فى أرقـــــام
              </div>
      ...
      <section class="awards-section mb-section py-section">
        <div class="container-xl">
          <div class="row">
            <div class="title__section text-center">
              <div class="subhead text-blue mb-2"><span>شركائنا</span></div>
              <div class="head text-primary">جــوائـز جـــيل</div>
            </div>
          </div>
        </div>

        <ul id="awards" class="awards">
          <li class="award-item">
            <div class="d-flex align-items-center">
              <div class="logo-award">

                <img src="{{ asset('front-assets/images/Kiwitech.svg')}}">
              </div>
              <div class="desc-awrad">
                <h4 class="text-primary mb-2">
                  أفضل 3O شركات ناشئة
                </h4>
                <p>
                  التأهل بين 30 شركة ناشئة للمراحل النهائية من مسابقة 2021 istanbul Off Take
                </p>
              </div>
            </div>
          </li>
          <li class="award-item">
            <div class="d-flex align-items-center">
              <div class="logo-award">
                <img src="{{ asset('front-assets/images/takeoff.svg')}}">


              </div>
              <div class="desc-awrad">
                <h4 class="text-primary mb-2">
                  مشاركة في فعــــاليات
                  الشركات الناشئة
                </h4>
                <p>
                  المشاركة في عدة فعاليات للشركات الناشئة نظمتها مؤسسة KiwiTech تلبية لدعوة
                  المؤسسة
                </p>
              </div>
            </div>
      ...
      <section class="testimonial-section mb-section py-section">
        <div class="container-xl">
          ...
          <div class="comment">
            ...
            <div class="descripe">
              <h2 class="text-primary mb-4">“منصة جيل كانت الأفضل بالنسبة لأبنائي لاحظت تطور كبير في مستواهم وشغفهم
                الكبير
                والجديد في حب
      ...
      <!--==============================End CTA Section ==============================-->
      <!--==============================Start Ecommerce-Product ==============================-->
      <section class="ecommerce-product mb-section py-section">
        <div class="container-xl">
          <div class="row align-items-center">
            <div class="col-sm-6">
              <div class="main-banner">
                <img src="{{ asset('front-assets/images/products.png')}}" alt="">
              </div>
            </div>
            <div class="col-sm-6">
              <div class="title__section">
                <div class="subhaed text-blue mb-2">
                  <span> منتجاتنا الشقيقة </span>
                </div>
                <div class="head text-primary mb-2"> متجـــر جـــــــــــيل! </div>
                <div class="main-text">
                  <p>
                    ملابس وألعاب وأدوات وغيرها الكثير بشخصيات جيل الحصرية
                  </p>
                </div>
                  ...
                  <ul class="d-flex align-items-center">
                    ...
                    <li>
                      <a href="javascript:;">
                        <svg width="37" height="37" viewBox="0 0 37 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path opacity="0.1" fill-rule="evenodd" clip-rule="evenodd" d="M18.5 35.7861C28.165 35.7861 36 27.9511 36 18.2861C36 8.62115 28.165 0.786133 18.5 0.786133C8.83502 0.786133 1 8.62115 1 18.2861C1 27.9511 8.83502 35.7861 18.5 35.7861Z" stroke="#88115F" stroke-width="1.5"></path>
                          <path d="M14.4835 14.7532C15.3029 14.7532 15.9671 14.089 15.9671 13.2697C15.9671 12.4503 15.3029 11.7861 14.4835 11.7861C13.6642 11.7861 13 12.4503 13 13.2697C13 14.089 13.6642 14.7532 14.4835 14.7532Z" fill="#88115F"></path>
                          <path d="M15.7198 15.7441H13.2473C13.1108 15.7441 13 15.8549 13 15.9914V23.4091C13 23.5456 13.1108 23.6564 13.2473 23.6564H15.7198C15.8563 23.6564 15.9671 23.5456 15.9671 23.4091V15.9914C15.9671 15.8549 15.8563 15.7441 15.7198 15.7441Z" fill="#88115F"></path>
                          <path d="M23.088 15.333C22.0313 14.971 20.7094 15.289 19.9167 15.8592C19.8895 15.7529 19.7926 15.6737 19.6774 15.6737H17.2048C17.0683 15.6737 16.9575 15.7845 16.9575 15.921V23.3387C16.9575 23.4752 17.0683 23.586 17.2048 23.586H19.6774C19.8138 23.586 19.9246 23.4752 19.9246 23.3387V18.0079C20.3242 17.6637 20.839 17.5539 21.2603 17.7329C21.6688 17.9055 21.9027 18.3268 21.9027 18.8881V23.3387C21.9027 23.4752 22.0135 23.586 22.1499 23.586H24.6225C24.759 23.586 24.8698 23.4752 24.8698 23.3387V18.3901C24.8416 16.3582 23.8857 15.606 23.088 15.333Z" fill="#88115F"></path>
                        </svg>
                    ...
                    <li>
                      <a href="javascript:;">
                        <svg width="37" height="37" viewBox="0 0 37 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path opacity="0.1" fill-rule="evenodd" clip-rule="evenodd" d="M18.5 35.7861C28.165 35.7861 36 27.9511 36 18.2861C36 8.62115 28.165 0.786133 18.5 0.786133C8.83502 0.786133 1 8.62115 1 18.2861C1 27.9511 8.83502 35.7861 18.5 35.7861Z" stroke="#88115F" stroke-width="1.5"></path>
                          <path d="M11.2211 25.3001H13.9027V18.7875L10.0718 15.9143V24.1508C10.0718 24.7867 10.587 25.3001 11.2211 25.3001Z" fill="#88115F"></path>
                          <path d="M23.0972 25.3001H25.7788C26.4148 25.3001 26.9281 24.7848 26.9281 24.1508V15.9143L23.0972 18.7875" fill="#88115F"></path>
                          <path d="M23.0972 13.8073V18.7875L26.9281 15.9143V14.382C26.9281 12.9607 25.3057 12.1504 24.1698 13.0028" fill="#88115F"></path>
                          <path d="M13.9033 18.7873V13.8071L18.5004 17.255L23.0976 13.8071V18.7873L18.5004 22.2352" fill="#88115F">
                          </path>
                          <path d="M10.0718 14.382V15.9143L13.9027 18.7875V13.8073L12.83 13.0028C11.6923 12.1504 10.0718 12.9607 10.0718 14.382Z" fill="#88115F"></path>
                        </svg>
                ...
                <div class="option">
                  <ul>
                    <li>احصل على خصم 50% على أول طلب لك</li>
                    <li>استمتع بشحن مجاني على الطلبات</li>
                    <li>ملابس لشخصيات طفلك المفضلة</li>
                    <li>اكتشف تشكيلة جديدة من المنتجات</li>
                  </ul>
                </div>
                <div class="more">
