...
@section('content')
<h4 class="py-3 mb-4">
  <span class="text-muted fw-light">Add /</span> FAQs
</h4>
...
<div class="row">
  ...
  <div class="col-md-12">
    <div class="card mb-4">
      <h5 class="card-header">New FAQs</h5>
      <form name="myForm" id="myForm" method="POST" action="{{ url(app()->getLocale() .'/dashboard/faq/add') }}" enctype="multipart/form-data">
        @csrf
