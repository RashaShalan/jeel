          ...
          <nav aria-label="Page navigation">
            <ul class="pagination">
              <li class="page-item first">
                <a class="page-link" href="javascript:void(0);"><i class="tf-icon mdi mdi-chevron-double-left"></i></a>
              </li>
              ...
              <li class="page-item last">
                <a class="page-link" href="javascript:void(0);"><i class="tf-icon mdi mdi-chevron-double-right"></i></a>
              </li>
            </ul>
          </nav>
          <!--/ Basic Pagination -->
        ...
        <div class="demo-inline-spacing">
          ...
          <nav aria-label="Page navigation">
            <ul class="pagination pagination-lg">
              <li class="page-item prev">
                <a class="page-link" href="javascript:void(0);"><i class="tf-icon mdi mdi-chevron-double-left mdi-20px"></i></a>
              </li>
              <li class="page-item">
                <a class="page-link" href="javascript:void(0);">1</a>
              </li>
              ...
              <li class="page-item next">
                <a class="page-link" href="javascript:void(0);"><i class="tf-icon mdi mdi-chevron-double-right mdi-20px"></i></a>
              </li>
            </ul>
          </nav>
        </div>
  ...
  <div class="card-body">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb mb-0">
        <li class="breadcrumb-item">
          <a href="javascript:void(0);" class="d-flex align-items-center"><i class="mdi mdi-star me-1 text-body"></i>Home</a>
        </li>
        <li class="breadcrumb-item">
          <a href="javascript:void(0);" class="d-flex align-items-center"><i class="mdi mdi-star me-1 text-body"></i>Library</a>
        </li>
        <li class="breadcrumb-item active">
          <a href="javascript:void(0);" class="d-flex align-items-center"><i class="mdi mdi-star me-1 text-body"></i>Data</a>
        </li>
      </ol>
    </nav>
    <!--/ Basic Breadcrumb with icon -->
